...
# to be organised
format_mp3 = StringVar()
format_mp4 = StringVar()
...
def main_text():
    ...
    # Format selector
    format_selector = tk.Radiobutton(root, text="mp3", variable=format_mp3)
    format_selector.place(relx=0.5, rely=0.35, anchor='center')  # Position

    # Convert button
    convert = tk.Button(root, text="Convert", command=youtube_link)
    convert.place(relx=0.5, rely=0.44, anchor='center')  # Position
